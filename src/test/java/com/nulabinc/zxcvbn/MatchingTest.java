...
public class MatchingTest {
  ...
  public static class DictionaryMatchingTest {
    ...
    public DictionaryMatchingTest(
        String password, String message, ExpectedMatch[] expectedMatches) {
    ...
    public void setUp() throws Exception {
      dictionaries.put("d1", dictionary("motherboard", "mother", "board", "abcd", "cdef"));
      dictionaries.put("d2", dictionary("z", "8", "99", "$", "asdf1234&*"));
    }
          ...
          new Object[][] {
            {
              ...
              new ExpectedMatch[] {
                new ExpectedMatch("mother", 0, 5)
                    .matchedWord("mother")
                    .dictionaryName("d1")
                    .rank(2),
                new ExpectedMatch("motherboard", 0, 10)
  ...
  public static class L33tMatchingTest {
    private final Map<Character, List<Character>> testTable =
    ...
    public void testL33tMatching() throws Exception {
      ...
      assertEquals(
          msg,
          expected.size(),
          new L33tMatcher(context, Collections.<String, Map<String, Integer>>emptyMap())
              .relevantL33tSubTable(password, testTable)
              .size());
    }
  ...
  public static class SpatialMatchingSimpleTest {
    ...
    @Parameterized.Parameters(name = "{0}")
    public static Collection<Object[]> data() {
      return Arrays.asList(new Object[][] {{""}, {"/"}, {"qw"}, {"*/"}});
    }
  }
  ...
  public static class SpatialMatchingTest {
    ...
    public void testSpatialMatching() throws Exception {
      Context context = StandardContext.build();
      List<Match> actualMatches =
          new SpatialMatcher(context, Collections.singletonMap(keyboard.getName(), keyboard))
              .execute(token);
  ...
  public static class RepeatMatchingTest {
    ...
    public void testRepeatMatching() throws Exception {
      ...
      assertMatches(
          ...
          Pattern.Repeat,
          new ExpectedMatch[] {expectedMatch},
          actualMatches);
    }
  ...
  public static class DateMatchingTest {
    ...
    public static Collection<Object[]> data() {
      ...
      for (final String order : new String[] {"mdy", "dmy", "ymd", "ydm"}) {
        final String password = order.replace("y", "88").replace("m", "8").replace("d", "8");
        data.add(
            new Object[] {
              password,
  ...
  public static class RestMatchingTest {
    ...
    public void testReverseDictionaryMatching() throws Exception {
      Context context = StandardContext.build();
      ReverseDictionaryMatcher reverseDictionaryMatcher =
          new ReverseDictionaryMatcher(
              context,
              new HashMap<String, Map<String, Integer>>() {
                {
                  put("d1", dictionary("123", "321", "456", "654"));
                }
              });
      ...
      ExpectedMatch[] expectedMatches =
          new ExpectedMatch[] {
            new ExpectedMatch("123", 1, 3)
                .matchedWord("321")
                .reversed(true)
                .dictionaryName("d1")
                .rank(2),
            new ExpectedMatch("456", 4, 6)
                .matchedWord("654")
                .reversed(true)
                .dictionaryName("d1")
                .rank(4)
      ...
      assertMatches(
          "matches against reversed words", Pattern.Dictionary, expectedMatches, actualMatches);
    }
    ...
    public void testSpatialMatching() throws Exception {
      ...
      ExpectedMatch[] expectedMatches =
          new ExpectedMatch[] {
            new ExpectedMatch(token, 3, 3 + token.length() - 1)
                .graph(keyboard.getName())
                .turns(2)
                .shiftedCount(3)
          };
    ...
    public void testSequenceMatching() throws Exception {
      ...
      assertMatches(
          "matches overlapping patterns", Pattern.Sequence, expectedMatches, actualMatches);
    }
    ...
    public void testOmnimatch() throws Exception {
      ...
      for (Map.Entry<Pattern, Integer[]> testMatch : testMatches.entrySet()) {
        ...
        String msg =
            String.format(
                "for %s, matches a %s token at [%s, %s]", password, patternName.value(), i, j);
