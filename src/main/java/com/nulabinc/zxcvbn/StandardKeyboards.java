...
public class StandardKeyboards {
  ...
  public static final KeyboardLoader DVORAK_LOADER =
      new SlantedKeyboardLoader(
          DVORAK, new ClasspathResource(RESOURCES_PACKAGE_PATH + "dvorak.txt"));

  public static final KeyboardLoader JIS_LOADER =
      new SlantedKeyboardLoader(JIS, new ClasspathResource(RESOURCES_PACKAGE_PATH + "jis.txt"));

  public static final KeyboardLoader KEYPAD_LOADER =
      new AlignedKeyboardLoader(
          KEYPAD, new ClasspathResource(RESOURCES_PACKAGE_PATH + "keypad.txt"));

  public static final KeyboardLoader MAC_KEYPAD_LOADER =
      new AlignedKeyboardLoader(
          MAC_KEYPAD, new ClasspathResource(RESOURCES_PACKAGE_PATH + "mac_keypad.txt"));

  private static final KeyboardLoader[] ALL_LOADERS =
      new KeyboardLoader[] {
        QWERTY_LOADER, DVORAK_LOADER, JIS_LOADER, KEYPAD_LOADER, MAC_KEYPAD_LOADER
      };
